...
async def get_by_id(report_id: int) -> Optional[ResortReportRead]:
    ...
    return ResortReportRead.model_validate_json(obj.model_dump_json()) if obj else None
...
async def get_reports_by_file(resort_report_file: ResortReportFile) -> List[ResortReportRead]:
    ...
    return [ResortReportRead.model_validate_json(o.model_dump_json()) for o in objs]
...
async def create(data: ResortReportCreate) -> ResortReportRead:
    ...
    return ResortReportRead.model_validate_json(obj.model_dump_json())
